...
export default function ClientList() {
    ...
    const fetchClients = async (searchTerm) => {
        try {
            let url;
            if (searchTerm){
                url = CLIENT_API + `?search=${searchTerm}`;
            }
            else {
                url = CLIENT_API;
            }
      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            ...
            <BoldTableCell>Sector</BoldTableCell>
            <BoldTableCell>Unique ID</BoldTableCell>
            <BoldTableCell>Company Email</BoldTableCell>
            <BoldTableCell>Company Phone</BoldTableCell>
            <BoldTableCell>Post Code</BoldTableCell>
            <BoldTableCell>Address 1</BoldTableCell>
            <BoldTableCell>Address 2</BoldTableCell>
            <BoldTableCell>Key Personnel</BoldTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {clients.map((row) => (
            <TableRow key={row.id}>
              ...
              <TableCell>{row.unique_client_id}</TableCell>
              ...
              <TableCell>{row.key_personnel || `-`}</TableCell>
...
// import { CLIENT_API, PROJECT_API } from '../components/apis/api';
